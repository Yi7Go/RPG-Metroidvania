...
public class Enemy_Slime : Enemy
{
    ...
    [SerializeField] private GameObject slimPrefab;
    [SerializeField] private Vector2 minCreatiionVelocity;
    [SerializeField] private Vector2 maxCreatiionVelocity;
    ...
    public override void Die()
    {
        ...
        CreateSlime(slimeToCreate, slimPrefab);
    ...
    public void SetupSlime(int _facingDir)
    {
        ...
        float xvelocity = Random.Range(minCreatiionVelocity.x, maxCreatiionVelocity.x);
        float yvelocity = Random.Range(minCreatiionVelocity.y, maxCreatiionVelocity.y);
